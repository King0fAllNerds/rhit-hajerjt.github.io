...
var RBY = {
    ...
    Aerodactyl: {
      types: ['Rock', 'Flying'],
      bs: {hp: 80, at: 105, df: 75, sp: 130, sl: 60},
      weightkg: 59,
    },
    Alakazam: {
      types: ['Psychic'],
    ...
    Arbok: {types: ['Poison','Dragon'], bs: {hp: 60, at: 100, df: 80, sp: 105, sl: 65}, weightkg: 65},
    Arcanine: {
      types: ['Ice'],
      bs: {hp: 85, at: 115, df: 70, sp: 105, sl: 80},
      weightkg: 155,
    },
    Articuno: {
      types: ['Ice', 'Flying'],
      bs: {hp: 100, at: 105, df: 100, sp: 85, sl: 125},
      weightkg: 55.4,
    },
    Beedrill: {
      types: ['Bug', 'Electric'],
      bs: {hp: 65, at: 115, df: 50, sp: 122, sl: 45},
      weightkg: 29.5,
    },
    Bellsprout: {
      types: ['Grass', 'Poison'],
      bs: {hp: 50, at: 75, df: 45, sp: 20, sl: 70},
      weightkg: 4,
      nfe: true,
    },
    Blastoise: {
      types: ['Water'],
      bs: {hp: 110, at: 90, df: 100, sp: 50, sl: 85},
      weightkg: 85.5,
    },
    Bulbasaur: {
      types: ['Grass', 'Poison'],
    ...
    Butterfree: {
      types: ['Bug', 'Fairy'],
      bs: {hp: 80, at: 40, df: 90, sp: 95, sl: 80},
      weightkg: 32,
    },
    Caterpie: {
      types: ['Bug','Fairy'],
      bs: {hp: 55, at: 30, df: 30, sp: 20, sl: 20},
      weightkg: 2.9,
      nfe: true,
    },
    Chansey: {
    ...
    Charizard: {
      types: ['Fire', 'Dragon'],
      bs: {hp: 78, at: 84, df: 78, sp: 110, sl: 85},
      weightkg: 90.5,
    },
    Charmander: {
      types: ['Fire'],
    ...
    Cloyster: {
      types: ['Water', 'Ice'],
      bs: {hp: 60, at: 105, df: 180, sp: 70, sl: 85},
      weightkg: 132.5,
    },
    Cubone: {
      types: ['Ground'],
    ...
    Dewgong: {
      types: ['Water', 'Ice'],
      bs: {hp: 80, at: 105, df: 65, sp: 115, sl: 95},
      weightkg: 120,
    },
    Diglett: {
      types: ['Ground'],
    ...
    Dodrio: {
      types: ['Normal', 'Flying'],
      bs: {hp: 60, at: 110, df: 70, sp: 140, sl: 60},
      weightkg: 85.2,
    },
    Doduo: {
      types: ['Normal', 'Flying'],
    ...
    Dragonair: {
      types: ['Water','Dragon'],
      bs: {hp: 70, at: 70, df: 55, sp: 75, sl: 70},
      weightkg: 16.5,
      nfe: true,
    },
    Dragonite: {
      types: ['Water','Dragon'],
      bs: {hp: 100, at: 100, df: 90, sp: 90, sl: 100},
      weightkg: 210,
    },
    Dratini: {
      types: ['Water' ,'Dragon'],
      bs: {hp: 50, at: 50, df: 40, sp: 55, sl: 50},
      weightkg: 3.3,
      nfe: true,
    },
    Drowzee: {
    ...
    Dugtrio: {
      types: ['Ground'],
      bs: {hp: 55, at: 110, df: 70, sp: 120, sl: 70},
      weightkg: 33.3,
    },
    Eevee: {
      types: ['Normal'],
    ...
    Electrode: {
      types: ['Electric'],
      bs: {hp: 60, at: 90, df: 60, sp: 150, sl: 80},
      weightkg: 66.6,
    },
    Exeggcute: {
      types: ['Grass', 'Psychic'],
    ...
    Exeggutor: {
      types: ['Grass', 'Psychic'],
      bs: {hp: 95, at: 50, df: 85, sp: 55, sl: 125},
      weightkg: 120,
    },
    'Farfetch\u2019d': {
      types: ['Fighting', 'Flying'],
      bs: {hp: 55, at: 125, df: 60, sp: 130, sl: 58},
      weightkg: 15,
    },
    Fearow: {
      types: ['Normal', 'Flying'],
      bs: {hp: 75, at: 135, df: 75, sp: 100, sl: 61},
      weightkg: 38,
    },
    Flareon: {types: ['Fire'], bs: {hp: 110, at: 130, df: 70, sp: 95, sl: 110}, weightkg: 25},
    Gastly: {
      types: ['Ghost', 'Poison'],
    ...
    Goldeen: {
      types: ['Water'],
      bs: {hp: 45, at: 77, df: 60, sp: 73, sl: 50},
      weightkg: 15,
      nfe: true,
    },
    Golduck: {types: ['Water','Psychic'], bs: {hp: 85, at: 72, df: 78, sp: 95, sl: 80}, weightkg: 76.6},
    Golem: {
      types: ['Rock', 'Dragon'],
      bs: {hp: 80, at: 120, df: 130, sp: 55, sl: 55},
      weightkg: 300,
    },
    Graveler: {
      types: ['Rock'],
    ...
    Growlithe: {
      types: ['Ice'],
      bs: {hp: 55, at: 70, df: 40, sp: 70, sl: 50},
      weightkg: 19,
      nfe: true,
    },
    Gyarados: {
    ...
    Hitmonchan: {
      types: ['Fighting'],
      bs: {hp: 80, at: 105, df: 110, sp: 76, sl: 35},
      weightkg: 50.2,
    },
    Hitmonlee: {
      types: ['Fighting'],
      bs: {hp: 80, at: 120, df: 53, sp: 107, sl: 35},
      weightkg: 49.8,
    },
    Horsea: {
      types: ['Water'],
    ...
    Hypno: {
      types: ['Psychic', 'Dark'],
      bs: {hp: 95, at: 90, df: 90, sp: 50, sl: 115},
      weightkg: 75.6,
    },
    Ivysaur: {
      types: ['Grass', 'Poison'],
    ...
    Jigglypuff: {
      types: ['Normal'],
      bs: {hp: 115, at: 55, df: 30, sp: 30, sl: 25},
      weightkg: 5.5,
      nfe: true,
    },
    Jolteon: {
      types: ['Electric'],
      bs: {hp: 70, at: 80, df: 60, sp: 130, sl: 110},
      weightkg: 24.5,
    },
    Jynx: {
      types: ['Ice', 'Psychic'],
      bs: {hp: 85, at: 40, df: 65, sp: 95, sl: 95},
      weightkg: 40.6,
    },
    Kabuto: {
      types: ['Bug', 'Water'],
    ...
    Kabutops: {
      types: ['Bug', 'Water'],
      bs: {hp: 60, at: 130, df: 105, sp: 80, sl: 70},
      weightkg: 40.5,
    },
    Kadabra: {
      types: ['Psychic'],
    ...
    Kakuna: {
      types: ['Bug', 'Electric'],
      bs: {hp: 50, at: 70, df: 80, sp: 60, sl: 25},
      weightkg: 10,
      nfe: true,
    },
    Kangaskhan: {
      types: ['Normal','Dragon'],
      bs: {hp: 105, at: 95, df: 100, sp: 40, sl: 40},
      weightkg: 80,
    },
    Kingler: {types: ['Water', 'Bug'], bs: {hp: 65, at: 130, df: 155, sp: 75, sl: 50}, weightkg: 60},
    Koffing: {
      types: ['Poison'],
    ...
    Lapras: {
      types: ['Water', 'Ice'],
      bs: {hp: 130, at: 95, df: 80, sp: 60, sl: 95},
      weightkg: 220,
    },
    Lickitung: {
      types: ['Normal'],
    ...
    Machamp: {
      types: ['Fighting'],
      bs: {hp: 90, at: 130, df: 80, sp: 70, sl: 65},
      weightkg: 130,
    },
    Machoke: {
      types: ['Fighting'],
    ...
    Marowak: {types: ['Ground'], bs: {hp: 60, at: 80, df: 110, sp: 85, sl: 50}, weightkg: 45},
    Meowth: {
      types: ['Normal'],
    ...
    Metapod: {
      types: ['Bug','Fairy'],
      bs: {hp: 60, at: 50, df: 80, sp: 35, sl: 25},
      weightkg: 9.9,
      nfe: true,
    },
    Mew: {
    ...
    Moltres: {
      types: ['Fire', 'Flying'],
      bs: {hp: 95, at: 125, df: 90, sp: 110, sl: 125},
      weightkg: 60,
    },
    'Mr. Mime': {
      types: ['Psychic'],
      bs: {hp: 40, at: 20, df: 120, sp: 105, sl: 100},
      weightkg: 54.5,
    },
    Muk: {types: ['Poison'], bs: {hp: 105, at: 105, df: 75, sp: 50, sl: 65}, weightkg: 30},
    Nidoking: {
      types: ['Poison', 'Ground'],
      bs: {hp: 90, at: 105, df: 75, sp: 90, sl: 75},
      weightkg: 62,
    },
    Nidoqueen: {
      types: ['Poison', 'Ground'],
      bs: {hp: 105, at: 75, df: 90, sp: 75, sl: 75},
      weightkg: 60,
    },
    'Nidoran-F': {
      types: ['Poison'],
    ...
    Ninetales: {
      types: ['Fire','Fairy'],
      bs: {hp: 73, at: 57, df: 75, sp: 109, sl: 100},
      weightkg: 19.9,
    },
    Oddish: {
      types: ['Grass', 'Poison'],
    ...
    Onix: {
      types: ['Rock', 'Ground'],
      bs: {hp: 35, at: 75, df: 160, sp: 80, sl: 30},
      weightkg: 210,
    },
    Paras: {
      types: ['Poison', 'Fairy'],
      bs: {hp: 45, at: 70, df: 55, sp: 30, sl: 55},
      weightkg: 5.4,
      nfe: true,
    },
    Parasect: {
      types: ['Poison', 'Fairy'],
      bs: {hp: 90, at: 85, df: 110, sp: 20, sl: 80},
      weightkg: 29.5,
    },
    Persian: {types: ['Normal'], bs: {hp: 65, at: 115, df: 60, sp: 115, sl: 65}, weightkg: 32},
    Pidgeot: {
      types: ['Normal', 'Flying'],
      bs: {hp: 85, at: 60, df: 70, sp: 115, sl: 70},
      weightkg: 39.5,
    },
    Pidgeotto: {
      types: ['Normal', 'Flying'],
      bs: {hp: 63, at: 50, df: 50, sp: 71, sl: 50},
      weightkg: 30,
      nfe: true,
    },
    Pidgey: {
      types: ['Normal', 'Flying'],
      bs: {hp: 40, at: 35, df: 35, sp: 56, sl: 35},
      weightkg: 1.8,
      nfe: true,
    },
    Pikachu: {
      types: ['Electric'],
      bs: {hp: 45, at: 85, df: 40, sp: 135, sl: 50},
      weightkg: 6,
      nfe: true,
    },
    Pinsir: {types: ['Bug','Ground'], bs: {hp: 100, at: 125, df: 100, sp: 75, sl: 55}, weightkg: 55},
    Poliwag: {
      types: ['Water'],
    ...
    Poliwrath: {
      ...
      bs: {hp: 110, at: 95, df: 95, sp: 70, sl: 70},
      weightkg: 54,
    },
    Ponyta: {
      types: ['Water', 'Fairy'],
      bs: {hp: 65, at: 50, df: 65, sp: 105, sl: 65},
      weightkg: 30,
      nfe: true,
    },
    Porygon: {
      types: ['Electric'],
      bs: {hp: 65, at: 40, df: 75, sp: 50, sl: 75},
      weightkg: 36.5,
    },
    Primeape: {
      types: ['Fighting'],
      bs: {hp: 85, at: 115, df: 60, sp: 120, sl: 60},
      weightkg: 32,
    },
    Psyduck: {
      types: ['Water'],
    ...
    Raichu: {
      types: ['Electric', 'Ice'],
      bs: {hp: 70, at: 60, df: 75, sp: 105, sl: 90},
      weightkg: 30,
    },
    Rapidash: {types: ['Water', 'Fairy'], bs: {hp: 90, at: 50, df: 75, sp: 110, sl: 80}, weightkg: 95},
    Raticate: {
      types: ['Normal','Dark'],
      bs: {hp: 75, at: 137, df: 80, sp: 113, sl: 50},
      weightkg: 18.5,
    },
    Rattata: {
      types: ['Normal','Dark'],
    ...
    Sandshrew: {
      types: ['Rock'],
      bs: {hp: 50, at: 85, df: 110, sp: 50, sl: 30},
      weightkg: 12,
      nfe: true,
    },
    Sandslash: {
      types: ['Rock'],
      bs: {hp: 75, at: 115, df: 150, sp: 95, sl: 55},
      weightkg: 29.5,
    },
    Scyther: {
      types: ['Bug', 'Ice'],
      bs: {hp: 80, at: 110, df: 60, sp: 120, sl: 55},
      weightkg: 56,
    },
    Seadra: {types: ['Water'], bs: {hp: 55, at: 65, df: 95, sp: 85, sl: 95}, weightkg: 25},
    Seaking: {types: ['Water'], bs: {hp: 100, at: 132, df: 80, sp: 88, sl: 80}, weightkg: 39},
    Seel: {
      types: ['Water'],
    ...
    Tauros: {
      types: ['Normal'],
      bs: {hp: 100, at: 115, df: 95, sp: 110, sl: 70},
      weightkg: 88.4,
    },
    Tentacool: {
      types: ['Water', 'Poison'],
    ...
    Vaporeon: {
      types: ['Water'],
      bs: {hp: 130, at: 80, df: 60, sp: 70, sl: 110},
      weightkg: 29,
    },
    Venomoth: {
      types: ['Bug', 'Poison'],
      bs: {hp: 70, at: 55, df: 60, sp: 110, sl: 90},
      weightkg: 12.5,
    },
    Venonat: {
      types: ['Bug', 'Poison'],
    ...
    Venusaur: {
      types: ['Grass', 'Poison'],
      bs: {hp: 80, at: 100, df: 85, sp: 80, sl: 100},
      weightkg: 100,
    },
    Victreebel: {
      types: ['Grass', 'Poison'],
      bs: {hp: 80, at: 105, df: 95, sp: 40, sl: 100},
      weightkg: 15.5,
    },
    Vileplume: {
      types: ['Grass', 'Poison'],
      bs: {hp: 95, at: 50, df: 85, sp: 50, sl: 100},
      weightkg: 18.6,
    },
    Voltorb: {
      types: ['Electric'],
    ...
    Weedle: {
      types: ['Bug', 'Electric'],
      bs: {hp: 30, at: 45, df: 25, sp: 60, sl: 20},
      weightkg: 3.2,
      nfe: true,
    },
    Weepinbell: {
      types: ['Grass', 'Poison'],
      bs: {hp: 65, at: 90, df: 65, sp: 30, sl: 85},
      weightkg: 6.4,
      nfe: true,
    },
    Weezing: {
      types: ['Poison'],
      bs: {hp: 85, at: 95, df: 120, sp: 50, sl: 85},
      weightkg: 9.5,
    },
    Wigglytuff: {
      types: ['Normal'],
      bs: {hp: 175, at: 90, df: 60, sp: 55, sl: 50},
      weightkg: 12,
    },
    Zapdos: {
      types: ['Electric', 'Flying'],
      bs: {hp: 90, at: 100, df: 85, sp: 130, sl: 125},
      weightkg: 52.6,
    },
    Zubat: {
      types: ['Poison', 'Flying'],
...
var GSC_PATCH = {
    ...
    Arbok: {bs: {sa: 50, sd: 110}},
    Arcanine: {bs: {sa: 105, sd: 75}},
    Articuno: {bs: {sa: 115, sd: 125}, gender: 'N'},
    Beedrill: {bs: {sa: 110, sd: 65}},
    Bellsprout: {bs: {sa: 70, sd: 50}},
    Blastoise: {bs: {sa: 90, sd: 105}},
    Bulbasaur: {bs: {sa: 65, sd: 65}},
    Butterfree: {bs: {sa: 100, sd: 130}},
    Caterpie: {bs: {sa: 40, sd: 40}},
    ...
    Weedle: {bs: {sa: 35, sd: 20}},
    Weepinbell: {bs: {sa: 85, sd: 75}},
    Weezing: {bs: {sa: 95, sd: 75}},
    Wigglytuff: {bs: {sa: 95, sd: 65}},
    Zapdos: {bs: {sa: 135, sd: 90}, gender: 'N'},
    Zubat: {bs: {sa: 30, sd: 40}},
    // gen 2 pokemon
    Aipom: {types: ['Normal','Fighting'], bs: {hp: 65, at: 80, df: 65, sa: 35, sd: 45, sp: 90}, weightkg: 11.5},
    Ampharos: {
      types: ['Grass','Normal'],
      bs: {hp: 100, at: 45, df: 80, sa: 115, sd: 110, sp: 50},
      weightkg: 61.5,
    },
    Ariados: {
      types: ['Bug', 'Dark'],
      bs: {hp: 80, at: 130, df: 80, sa: 50, sd: 90, sp: 97},
      weightkg: 33.5,
    },
    Azumarill: {
      types: ['Water'],
    ...
    Bayleef: {
      types: ['Grass'],
      bs: {hp: 70, at: 42, df: 80, sa: 73, sd: 80, sp: 60},
      weightkg: 15.8,
      nfe: true,
    },
    Bellossom: {
      types: ['Grass','Fairy'],
      bs: {hp: 75, at: 50, df: 95, sa: 100, sd: 100, sp: 110},
      weightkg: 5.8,
    },
    Blissey: {
      types: ['Normal'],
    ...
    Chikorita: {
      types: ['Grass'],
      bs: {hp: 55, at: 29, df: 65, sa: 59, sd: 65, sp: 45},
      weightkg: 6.4,
      nfe: true,
    },
    Chinchou: {
      types: ['Water', 'Ghost'],
      bs: {hp: 75, at: 40, df: 60, sa: 60, sd: 70, sp: 35},
      weightkg: 12,
      nfe: true,
    },
    Cleffa: {
    ...
    Corsola: {
      types: ['Water', 'Rock'],
      bs: {hp: 75, at: 45, df: 150, sa: 90, sd: 150, sp: 35},
      weightkg: 5,
    },
    Crobat: {
      types: ['Poison', 'Flying'],
      bs: {hp: 85, at: 95, df: 80, sa: 85, sd: 80, sp: 130},
      weightkg: 75,
    },
    Croconaw: {
      types: ['Water'],
    ...
    Delibird: {
      types: ['Ice', 'Flying'],
      bs: {hp: 75, at: 110, df: 50, sa: 110, sd: 50, sp: 110},
      weightkg: 16,
    },
    Donphan: {
      types: ['Ground'],
      bs: {hp: 90, at: 120, df: 120, sa: 60, sd: 80, sp: 50},
      weightkg: 120,
    },
    Dunsparce: {
      types: ['Ground','Steel'],
      bs: {hp: 70, at: 130, df: 90, sa: 45, sd: 65, sp: 125},
      weightkg: 14,
    },
    Elekid: {
      types: ['Electric'],
    ...
    Espeon: {
      types: ['Psychic'],
      bs: {hp: 80, at: 70, df: 60, sa: 130, sd: 95, sp: 110},
      weightkg: 26.5,
    },
    Feraligatr: {
      types: ['Water','Dark'],
      bs: {hp: 85, at: 120, df: 100, sa: 69, sd: 83, sp: 88},
      weightkg: 88.8,
    },
    Flaaffy: {
      types: ['Grass','Water'],
      bs: {hp: 80, at: 35, df: 60, sa: 80, sd: 65, sp: 45},
      weightkg: 13.3,
      nfe: true,
    },
    Forretress: {
      types: ['Flying', 'Electric'],
      bs: {hp: 85, at: 40, df: 65, sa: 140, sd: 75, sp: 105},
      weightkg: 125.8,
    },
    Furret: {types: ['Normal','Ice'], bs: {hp: 80, at: 110, df: 75, sa: 95, sd: 65, sp: 115}, weightkg: 32.5},
    Girafarig: {
      types: ['Fairy', 'Dark'],
      bs: {hp: 70, at: 55, df: 65, sa: 135, sd: 65, sp: 115},
      weightkg: 41.5,
    },
    Gligar: {
      types: ['Ground', 'Flying'],
    ...
    Granbull: {
      ...
      bs: {hp: 90, at: 120, df: 85, sa: 60, sd: 80, sp: 95},
      weightkg: 48.7,
    },
    Heracross: {
      types: ['Bug', 'Fighting'],
      bs: {hp: 100, at: 125, df: 75, sa: 40, sd: 95, sp: 85},
      weightkg: 54,
    },
    Hitmontop: {
      types: ['Fighting'],
      bs: {hp: 80, at: 110, df: 90, sa: 35, sd: 100, sp: 90},
      weightkg: 48,
    },
    'Ho-Oh': {
      types: ['Fire', 'Flying'],
    ...
    Hoothoot: {
      types: ['Ice', 'Flying'],
      bs: {hp: 60, at: 30, df: 30, sa: 66, sd: 56, sp: 60},
      weightkg: 21.2,
      nfe: true,
    },
    Hoppip: {
      types: ['Grass', 'Flying'],
      bs: {hp: 35, at: 45, df: 40, sa: 45, sd: 55, sp: 60},
      weightkg: 0.5,
      nfe: true,
    },
    Houndoom: {
      types: ['Dark', 'Fire'],
      bs: {hp: 85, at: 70, df: 70, sa: 120, sd: 80, sp: 105},
      weightkg: 35,
    },
    Houndour: {
      types: ['Dark', 'Fire'],
    ...
    Jumpluff: {
      types: ['Grass', 'Flying'],
      bs: {hp: 65, at: 110, df: 70, sa: 110, sd: 75, sp: 120},
      weightkg: 3,
    },
    Kingdra: {
      types: ['Water', 'Dragon'],
      bs: {hp: 75, at: 105, df: 95, sa: 105, sd: 95, sp: 80},
      weightkg: 152,
    },
    Lanturn: {
      types: ['Water', 'Ghost'],
      bs: {hp: 135, at: 55, df: 80, sa: 90, sd: 100, sp: 60},
      weightkg: 22.5,
    },
    Larvitar: {
      types: ['Rock', 'Ground'],
    ...
    Ledian: {
      types: ['Bug', 'Fighting'],
      bs: {hp: 65, at: 125, df: 70, sa: 55, sd: 90, sp: 105},
      weightkg: 35.6,
    },
    Ledyba: {
      types: ['Bug', 'Flying'],
    ...
    Magcargo: {
      types: ['Poison', 'Steel'],
      bs: {hp: 80, at: 85, df: 135, sa: 100, sd: 100, sp: 10},
      weightkg: 55,
    },
    Mantine: {
      types: ['Water', 'Flying'],
      bs: {hp: 95, at: 40, df: 80, sa: 100, sd: 140, sp: 70},
      weightkg: 220,
    },
    Mareep: {
      types: ['Grass','Normal'],
      bs: {hp: 60, at: 25, df: 45, sa: 65, sd: 50, sp: 35},
      weightkg: 7.8,
      nfe: true,
    },
    Marill: {
    ...
    Meganium: {
      types: ['Grass', 'Fairy'],
      bs: {hp: 100, at: 52, df: 100, sa: 103, sd: 110, sp: 80},
      weightkg: 100.5,
    },
    Miltank: {
      types: ['Normal'],
      bs: {hp: 95, at: 100, df: 105, sa: 40, sd: 90, sp: 100},
      weightkg: 75.5,
    },
    Misdreavus: {
      types: ['Ghost', 'Fairy'],
    ...
    Noctowl: {
      types: ['Ghost', 'Flying'],
      bs: {hp: 100, at: 40, df: 70, sa: 116, sd: 116, sp: 80},
      weightkg: 40.8,
    },
    Octillery: {
      types: ['Water','Fire'],
      bs: {hp: 90, at: 75, df: 75, sa: 120, sd: 75, sp: 95},
      weightkg: 28.5,
    },
    Phanpy: {
      types: ['Ground'],
    ...
    Pineco: {
      types: ['Flying'],
      bs: {hp: 50, at: 15, df: 35, sa: 90, sd: 35, sp: 65},
      weightkg: 7.2,
      nfe: true,
    },
    Politoed: {
      types: ['Water'],
      bs: {hp: 110, at: 65, df: 75, sa: 100, sd: 100, sp: 70},
      weightkg: 33.9,
    },
    Porygon2: {
      types: ['Electric'],
      bs: {hp: 95, at: 40, df: 105, sa: 105, sd: 105, sp: 85},
      weightkg: 32.5,
      gender: 'N',
    },
    Pupitar: {
    ...
    Quagsire: {
      types: ['Water', 'Ground'],
      bs: {hp: 105, at: 90, df: 95, sa: 100, sd: 70, sp: 45},
      weightkg: 75,
    },
    Quilava: {
      types: ['Fire'],
    ...
    Qwilfish: {
      types: ['Water', 'Poison'],
      bs: {hp: 65, at: 105, df: 115, sa: 45, sd: 85, sp: 95},
      weightkg: 3.9,
    },
    Raikou: {
      types: ['Electric'],
    ...
    Remoraid: {
      types: ['Water'],
      bs: {hp: 35, at: 50, df: 35, sa: 90, sd: 35, sp: 75},
      weightkg: 12,
      nfe: true,
    },
    Scizor: {
      types: ['Bug', 'Steel'],
      bs: {hp: 70, at: 130, df: 100, sa: 80, sd: 80, sp: 65},
      weightkg: 118,
    },
    Sentret: {
      types: ['Normal','Ice'],
      bs: {hp: 35, at: 65, df: 45, sa: 45, sd: 45, sp: 70},
      weightkg: 6,
      nfe: true,
    },
    Shuckle: {
    ...
    Skarmory: {
      types: ['Steel', 'Flying'],
      bs: {hp: 65, at: 90, df: 140, sa: 40, sd: 70, sp: 70},
      weightkg: 50.5,
    },
    Skiploom: {
      types: ['Grass', 'Flying'],
      bs: {hp: 55, at: 65, df: 50, sa: 65, sd: 65, sp: 100},
      weightkg: 1,
      nfe: true,
    },
    Slowking: {
      types: ['Water', 'Psychic'],
      bs: {hp: 95, at: 65, df: 80, sa: 120, sd: 100, sp: 30},
      weightkg: 79.5,
    },
    Slugma: {
      types: ['Poison'],
      bs: {hp: 50, at: 60, df: 50, sa: 80, sd: 60, sp: 15},
      weightkg: 35,
      nfe: true,
    },
    Smeargle: {types: ['Normal'], bs: {hp: 55, at: 50, df: 35, sa: 50, sd: 45, sp: 95}, weightkg: 58},
    Smoochum: {
      types: ['Ice', 'Psychic'],
    ...
    Spinarak: {
      types: ['Bug', 'Dark'],
      bs: {hp: 50, at: 90, df: 40, sa: 20, sd: 50, sp: 60},
      weightkg: 8.5,
      nfe: true,
    },
    Stantler: {
      types: ['Normal','Psychic'],
      bs: {hp: 105, at: 105, df: 75, sa: 105, sd: 80, sp: 85},
      weightkg: 71.2,
    },
    Steelix: {
      types: ['Steel', 'Ground'],
    ...
    Sudowoodo: {
      types: ['Rock'],
      bs: {hp: 90, at: 115, df: 135, sa: 30, sd: 75, sp: 80},
      weightkg: 38,
    },
    Suicune: {
      types: ['Water'],
    ...
    Sunflora: {
      types: ['Grass','Fire'],
      bs: {hp: 85, at: 55, df: 85, sa: 130, sd: 90, sp: 75},
      weightkg: 8.5,
    },
    Sunkern: {
      types: ['Grass'],
    ...
    Togepi: {
      types: ['Grass','Water'],
      bs: {hp: 35, at: 30, df: 85, sa: 30, sd: 65, sp: 20},
      weightkg: 1.5,
      nfe: true,
    },
    Togetic: {
      types: ['Grass', 'Water'],
      bs: {hp: 55, at: 85, df: 110, sa: 40, sd: 75, sp: 40},
      weightkg: 3.2,
    },
    Totodile: {
      types: ['Water'],
    ...
    Typhlosion: {
      types: ['Fire'],
      bs: {hp: 78, at: 83, df: 73, sa: 130, sd: 80, sp: 101},
      weightkg: 79.5,
    },
    Tyranitar: {
      types: ['Rock', 'Dark'],
    ...
    Umbreon: {types: ['Dark'], bs: {hp: 80, at: 95, df: 110, sa: 60, sd: 130, sp: 70}, weightkg: 27},
    Unown: {
      types: ['Psychic'],
    ...
    Xatu: {
      types: ['Psychic', 'Flying'],
      bs: {hp: 65, at: 50, df: 70, sa: 120, sd: 90, sp: 115},
      weightkg: 15,
    },
    Yanma: {
      types: ['Bug', 'Flying'],
...
var ADV_PATCH = {
    ...
    Aerodactyl: {abilities: {0: 'Determined'}},
    Alakazam: {abilities: {0: 'Magic Guard'}},
    Arbok: {abilities: {0: 'Intimidate'}},
    Arcanine: {abilities: {0: 'Water Absorb'}},
    Articuno: {abilities: {0: 'Snow Warning'}},
    Beedrill: {abilities: {0: 'Technician'}},
    Bellsprout: {abilities: {0: 'Liquid Ooze'}},
    Blastoise: {abilities: {0: 'Drizzle'}},
    Bulbasaur: {abilities: {0: 'Chlorophyll'}},
    Butterfree: {abilities: {0: 'Tinted Lens'}},
    Caterpie: {abilities: {0: 'Stench'}},
    Chansey: {abilities: {0: 'Serene Grace'}},
    Charizard: {abilities: {0: 'Levitate'}},
    Charmander: {abilities: {0: 'Solar Power'}},
    Charmeleon: {abilities: {0: 'Solar Power'}},
    Clefable: {abilities: {0: 'Magic Guard'}},
    Clefairy: {abilities: {0: 'Magic Guard'}},
    Cloyster: {abilities: {0: 'Skill Link'}},
    Cubone: {abilities: {0: 'Determined'}},
    Dewgong: {abilities: {0: 'Deadeye'}},
    Diglett: {abilities: {0: 'Sand Veil'}},
    Ditto: {abilities: {0: 'Limber'}},
    Dodrio: {abilities: {0: 'Technician'}},
    Doduo: {abilities: {0: 'Technician'}},
    Dragonair: {abilities: {0: 'Swift Swim'}},
    Dragonite: {abilities: {0: 'Swift Swim'}},
    Dratini: {abilities: {0: 'Swift Swim'}},
    ...
    Electrode: {abilities: {0: 'Adaptability'}},
    ...
    Geodude: {abilities: {0: 'Rough Skin'}},
    Gloom: {abilities: {0: 'Chlorophyll'}},
    Golbat: {abilities: {0: 'Limber'}},
    Goldeen: {abilities: {0: 'Swift Swim'}},
    Golduck: {abilities: {0: 'Damp'}},
    Golem: {abilities: {0: 'Rough Skin'}},
    Graveler: {abilities: {0: 'Rough Skin'}},
    Grimer: {abilities: {0: 'Stench'}},
    Growlithe: {abilities: {0: 'Water Absorb'}},
    ...
    Ivysaur: {abilities: {0: 'Chlorophyll'}},
    Jigglypuff: {abilities: {0: 'Trace'}},
    ...
    Kakuna: {abilities: {0: 'BAttle Armor'}},
    Kangaskhan: {abilities: {0: 'Anger Point'}},
    Kingler: {abilities: {0: 'Rough Skin'}},
    Koffing: {abilities: {0: 'Levitate'}},
    Krabby: {abilities: {0: 'Rough Skin'}},
    Lapras: {abilities: {0: 'Serene Grace'}},
    Lickitung: {abilities: {0: 'Unaware'}},
    Machamp: {abilities: {0: 'No Guard'}},
    Machoke: {abilities: {0: 'No Guard'}},
    Machop: {abilities: {0: 'No Guard'}},
    Magikarp: {abilities: {0: 'Swift Swim'}},
    Magmar: {abilities: {0: 'Deadeye'}},
    Magnemite: {abilities: {0: 'Levitate'}},
    Magneton: {abilities: {0: 'Levitate'}},
    Mankey: {abilities: {0: 'Hustle'}},
    Marowak: {abilities: {0: 'Determined'}},
    Meowth: {abilities: {0: 'Technician'}},
    Metapod: {abilities: {0: 'Unaware'}},
    Mew: {abilities: {0: 'Synchronize'}},
    Mewtwo: {abilities: {0: 'Pressure'}},
    Moltres: {abilities: {0: 'Drought'}},
    'Mr. Mime': {abilities: {0: 'Filter'}},
    Muk: {abilities: {0: 'Stench'}},
    Nidoking: {abilities: {0: 'Instinct'}},
    ...
    Ponyta: {abilities: {0: 'Adaptability'}},
    Porygon: {abilities: {0: 'Levitate'}},
    Primeape: {abilities: {0: 'Simple Mind'}},
    Psyduck: {abilities: {0: 'Damp'}},
    Raichu: {abilities: {0: 'Static'}},
    Rapidash: {abilities: {0: 'Adaptability'}},
    Raticate: {abilities: {0: 'Hustle'}},
    Rattata: {abilities: {0: 'Hustle'}},
    Rhydon: {abilities: {0: 'Determined'}},
    Rhyhorn: {abilities: {0: 'Determined'}},
    ...
    Seaking: {abilities: {0: 'Strong Body'}},
    Seel: {abilities: {0: 'Deadeye'}},
    Shellder: {abilities: {0: 'Skill Link'}},
    Slowbro: {abilities: {0: 'Shell Armor'}},
    Slowpoke: {abilities: {0: 'Oblivious'}},
    Snorlax: {abilities: {0: 'Thick Fat'}},
    Spearow: {abilities: {0: 'Keen Eye'}},
    Squirtle: {abilities: {0: 'Rain Dish'}},
    Starmie: {abilities: {0: 'Deadeye'}},
    Staryu: {abilities: {0: 'Limber'}},
    Tangela: {abilities: {0: 'Tangled Feet'}},
    Tauros: {abilities: {0: 'Determined'}},
    ...
    Venonat: {abilities: {0: 'Tinted Lens'}},
    Venusaur: {abilities: {0: 'Chlorophyll'}},
    Victreebel: {abilities: {0: 'Liquid Ooze'}},
    Vileplume: {abilities: {0: 'Chlorophyll'}},
    Voltorb: {abilities: {0: 'Adaptability'}},
    Vulpix: {abilities: {0: 'Flash Fire'}},
    Wartortle: {abilities: {0: 'Rain Dish'}},
    Weedle: {abilities: {0: 'Illuminate'}},
    Weepinbell: {abilities: {0: 'Liquid Ooze'}},
    Weezing: {abilities: {0: 'Levitate'}},
    Wigglytuff: {abilities: {0: 'Trace'}},
    Zapdos: {abilities: {0: 'Drizzle'}},
    Zubat: {abilities: {0: 'Inner Focus'}},
    // gen 2 pokemon changes
    Aipom: {abilities: {0: 'Guts'}},
    Ampharos: {abilities: {0: 'Unaware'}},
    Ariados: {abilities: {0: 'Intimidate'}},
    Azumarill: {abilities: {0: 'Huge Power'}},
    Bayleef: {abilities: {0: 'Leaf Guard'}},
    Bellossom: {abilities: {0: 'Solar Power'}},
    Blissey: {abilities: {0: 'Serene Grace'}},
    Celebi: {abilities: {0: 'Natural Cure'}},
    Chikorita: {abilities: {0: 'Leaf Guard'}},
    Chinchou: {abilities: {0: 'Shield Dust'}},
    Cleffa: {abilities: {0: 'Magic Guard'}},
    Corsola: {abilities: {0: 'Solid Rock'}},
    Crobat: {abilities: {0: 'Limber'}},
    Croconaw: {abilities: {0: 'Intimidate'}},
    Cyndaquil: {abilities: {0: 'Adaptability'}},
    Delibird: {abilities: {0: 'Unaware'}},
    Donphan: {abilities: {0: 'Thick Fat'}},
    Dunsparce: {abilities: {0: 'Mold Breaker'}},
    Elekid: {abilities: {0: 'Static'}},
    Entei: {abilities: {0: 'Pressure'}},
    Espeon: {abilities: {0: 'Magic Guard'}},
    Feraligatr: {abilities: {0: 'Intimidate'}},
    Flaaffy: {abilities: {0: 'Unaware'}},
    Forretress: {abilities: {0: 'Motor Drive'}},
    Furret: {abilities: {0: 'Instinct'}},
    Girafarig: {abilities: {0: 'Huge Power'}},
    Gligar: {abilities: {0: 'Immunity'}},
    Granbull: {abilities: {0: 'Intimidate'}},
    Heracross: {abilities: {0: 'Strong Body'}},
    Hitmontop: {abilities: {0: 'Technician'}},
    'Ho-Oh': {abilities: {0: 'Pressure'}},
    Hoothoot: {abilities: {0: 'Snow Cloak'}},
    Hoppip: {abilities: {0: 'Simple Mind'}},
    Houndoom: {abilities: {0: 'Intimidate'}},
    Houndour: {abilities: {0: 'Intimidate'}},
    Igglybuff: {abilities: {0: 'Trace'}},
    Jumpluff: {abilities: {0: 'Simple Mind'}},
    Kingdra: {abilities: {0: 'Swift Swim'}},
    Lanturn: {abilities: {0: 'Shield Dust'}},
    Larvitar: {abilities: {0: 'Guts'}},
    Ledian: {abilities: {0: 'Technician'}},
    Ledyba: {abilities: {0: 'Technician'}},
    Lugia: {abilities: {0: 'Pressure'}},
    Magby: {abilities: {0: 'Deadeye'}},
    Magcargo: {abilities: {0: 'Aftermath'}},
    Mantine: {abilities: {0: 'Swift Swim'}},
    Mareep: {abilities: {0: 'Unaware'}},
    Marill: {abilities: {0: 'Huge Power'}},
    Meganium: {abilities: {0: 'Huge Power'}},
    Miltank: {abilities: {0: 'Thick Fat'}},
    Misdreavus: {abilities: {0: 'Levitate'}},
    Murkrow: {abilities: {0: 'Super Luck'}},
    Natu: {abilities: {0: 'Magic Guard'}},
    Noctowl: {abilities: {0: 'Ice Body'}},
    Octillery: {abilities: {0: 'Adaptability'}},
    Phanpy: {abilities: {0: 'Sand Veil'}},
    Pichu: {abilities: {0: 'Motor Drive'}},
    Piloswine: {abilities: {0: 'Thick Fat'}},
    Pineco: {abilities: {0: 'Motor Drive'}},
    Politoed: {abilities: {0: 'Drizzle'}},
    Porygon2: {abilities: {0: 'Levitate'}},
    Pupitar: {abilities: {0: 'Shed Skin'}},
    Quagsire: {abilities: {0: 'Simple'}},
    Quilava: {abilities: {0: 'Adaptability'}},
    Qwilfish: {abilities: {0: 'Intimidate'}},
    Raikou: {abilities: {0: 'Pressure'}},
    Remoraid: {abilities: {0: 'Adaptability'}},
    Scizor: {abilities: {0: 'Technician'}},
    Sentret: {abilities: {0: 'Frisk'}},
    Shuckle: {abilities: {0: 'Water Absorb'}},
    Skarmory: {abilities: {0: 'Battle Armor'}},
    Skiploom: {abilities: {0: 'Simple Mind'}},
    Slowking: {abilities: {0: 'Super Luck'}},
    Slugma: {abilities: {0: 'Stench'}},
    Smeargle: {abilities: {0: 'Technician'}},
    Smoochum: {abilities: {0: 'Hydration'}},
    Sneasel: {abilities: {0: 'Technician'}},
    Snubbull: {abilities: {0: 'Intimidate'}},
    Spinarak: {abilities: {0: 'Intimidate'}},
    Stantler: {abilities: {0: 'Intimidate'}},
    Steelix: {abilities: {0: 'Determined'}},
    Sudowoodo: {abilities: {0: 'Determined'}},
    Suicune: {abilities: {0: 'Pressure'}},
    Sunflora: {abilities: {0: 'Solar Power'}},
    Sunkern: {abilities: {0: 'Solar Power'}},
    Swinub: {abilities: {0: 'Thick Fat'}},
    Teddiursa: {abilities: {0: 'Pickup'}},
    Togepi: {abilities: {0: 'Water Absorb'}},
    Togetic: {abilities: {0: 'No Guard'}},
    Totodile: {abilities: {0: 'Intimidate'}},
    Typhlosion: {abilities: {0: 'Adaptability'}},
    Tyranitar: {abilities: {0: 'Sand Stream'}},
    Tyrogue: {abilities: {0: 'Steadfast'}},
    Umbreon: {abilities: {0: 'Magic Guard'}},
    Unown: {abilities: {0: 'Levitate'}},
    Ursaring: {abilities: {0: 'Guts'}},
    Wobbuffet: {abilities: {0: 'Shadow Tag'}},
    Wooper: {abilities: {0: 'Simple'}},
    Xatu: {abilities: {0: 'Magic Guard'}},
    Yanma: {abilities: {0: 'Speed Boost'}},
    // gen 3 pokemon
    Absol: {
      types: ['Dark','Steel'],
      bs: {hp: 65, at: 140, df: 85, sa: 45, sd: 65, sp: 100},
      weightkg: 47,
      abilities: {0: 'Limber'},
    },
    Aggron: {
      types: ['Steel', 'Fire'],
      bs: {hp: 70, at: 110, df: 115, sa: 95, sd: 60, sp: 80},
      weightkg: 360,
      abilities: {0: 'Water Absorb'},
    },
    Altaria: {
      types: ['Psychic', 'Dragon'],
      bs: {hp: 85, at: 90, df: 80, sa: 95, sd: 120, sp: 85},
      weightkg: 20.6,
    ...
    Armaldo: {
      types: ['Water', 'Bug'],
      bs: {hp: 75, at: 125, df: 100, sa: 50, sd: 80, sp: 95},
      weightkg: 68.2,
      abilities: {0: 'Tinted Lens'},
    },
    Aron: {
      types: ['Steel', 'Fire'],
      bs: {hp: 50, at: 80, df: 70, sa: 65, sd: 50, sp: 50},
      weightkg: 60,
      nfe: true,
      abilities: {0: 'Water Absorb'},
    },
    ...
    Banette: {
      types: ['Ghost','Normal'],
      bs: {hp: 84, at: 115, df: 75, sa: 63, sd: 113, sp: 70},
      weightkg: 12.5,
    ...
    Beautifly: {
      types: ['Bug', 'Flying'],
      bs: {hp: 60, at: 70, df: 60, sa: 135, sd: 90, sp: 115},
      weightkg: 28.4,
      abilities: {0: 'Tinted Lens'},
    },
    Beldum: {
    ...
    Blaziken: {
      types: ['Fire', 'Fighting'],
      bs: {hp: 90, at: 120, df: 80, sa: 100, sd: 75, sp: 80},
      weightkg: 52,
      abilities: {0: 'Determined'},
    },
    Breloom: {
      types: ['Grass', 'Fighting'],
      bs: {hp: 70, at: 130, df: 80, sa: 60, sd: 60, sp: 90},
      weightkg: 39.2,
    ...
    Cacturne: {
      types: ['Grass', 'Dark'],
      bs: {hp: 80, at: 115, df: 60, sa: 115, sd: 60, sp: 95},
      weightkg: 77.4,
      abilities: {0: 'Water Absorb'},
    },
    Camerupt: {
      types: ['Fire', 'Ground'],
      bs: {hp: 110, at: 100, df: 80, sa: 105, sd: 85, sp: 40},
      weightkg: 220,
    ...
    Castform: {
      types: ['Normal'],
      bs: {hp: 80, at: 40, df: 70, sa: 120, sd: 70, sp: 115},
      weightkg: 0.8,
    ...
    Chimecho: {
      types: ['Fairy','Flying'],
      bs: {hp: 78, at: 38, df: 88, sa: 88, sd: 128, sp: 128},
      weightkg: 1,
      abilities: {0: 'Unaware'},
    },
    Clamperl: {
    ...
    Claydol: {
      types: ['Ground', 'Psychic'],
      bs: {hp: 80, at: 70, df: 105, sa: 90, sd: 120, sp: 75},
      weightkg: 108,
      abilities: {0: 'Levitate'},
      gender: 'N',
    },
    ...
    Cradily: {
      types: ['Water', 'Grass'],
      bs: {hp: 96, at: 81, df: 107, sa: 91, sd: 107, sp: 43},
      weightkg: 60.4,
      abilities: {0: 'Suction Cups'},
    },
    Crawdaunt: {
      types: ['Water', 'Dark'],
      bs: {hp: 75, at: 120, df: 120, sa: 90, sd: 85, sp: 55},
      weightkg: 32.8,
      abilities: {0: 'Adaptability'},
    },
    Delcatty: {
      types: ['Normal','Fairy'],
      bs: {hp: 75, at: 110, df: 60, sa: 55, sd: 125, sp: 105},
      weightkg: 32.6,
      abilities: {0: 'Limber'},
    },
    Deoxys: {
    ...
    Dustox: {
      types: ['Bug', 'Poison'],
      bs: {hp: 90, at: 40, df: 85, sa: 105, sd: 115, sp: 95},
      weightkg: 31.6,
      abilities: {0: 'Shield Dust'},
    },
    Electrike: {
      types: ['Rock'],
      bs: {hp: 40, at: 35, df: 60, sa: 75, sd: 40, sp: 65},
      weightkg: 15.2,
      nfe: true,
    ...
    Exploud: {
      types: ['Normal'],
      bs: {hp: 105, at: 105, df: 75, sa: 105, sd: 85, sp: 70},
      weightkg: 84,
      abilities: {0: 'Scrappy'},
    },
    Feebas: {
    ...
    Flygon: {
      types: ['Fire', 'Electric'],
      bs: {hp: 65, at: 105, df: 70, sa: 105, sd: 75, sp: 125},
      weightkg: 82,
      abilities: {0: 'Deadeye'},
    },
    Gardevoir: {
      types: ['Psychic'],
      bs: {hp: 68, at: 50, df: 65, sa: 125, sd: 115, sp: 107},
      weightkg: 48.4,
      abilities: {0: 'Synchronize'},
    },
    Glalie: {
      types: ['Ice','Rock'],
      bs: {hp: 90, at: 110, df: 110, sa: 60, sd: 70, sp: 90},
      weightkg: 256.5,
      abilities: {0: 'Solid Rock'},
    },
    Gorebyss: {
      types: ['Water','Poison'],
      bs: {hp: 75, at: 100, df: 95, sa: 90, sd: 105, sp: 70},
      weightkg: 22.6,
    ...
    Grumpig: {
      types: ['Psychic'],
      bs: {hp: 110, at: 45, df: 75, sa: 110, sd: 110, sp: 80},
      weightkg: 71.5,
      abilities: {0: 'Thick Fat'},
    },
    Gulpin: {
      types: ['Poison'],
      bs: {hp: 120, at: 35, df: 45, sa: 50, sd: 40, sp: 40},
      weightkg: 10.3,
      nfe: true,
    ...
    Hariyama: {
      types: ['Fighting'],
      bs: {hp: 155, at: 120, df: 75, sa: 40, sd: 75, sp: 50},
      weightkg: 253.8,
      abilities: {0: 'Thick Fat'},
    },
    Huntail: {
      types: ['Water','Dark'],
      bs: {hp: 75, at: 104, df: 105, sa: 114, sd: 75, sp: 62},
      weightkg: 27,
      abilities: {0: 'Swift Swim'},
    },
    Illumise: {
      types: ['Bug','Fairy'],
      bs: {hp: 65, at: 33, df: 75, sa: 110, sd: 95, sp: 127},
      abilities: {0: 'Tinted Lens'},
      weightkg: 17.7,
    },
    Jirachi: {
    ...
    Kecleon: {
      types: ['Normal'],
      bs: {hp: 75, at: 105, df: 90, sa: 105, sd: 90, sp: 90},
      weightkg: 22,
      abilities: {0: 'Instinct'},
    },
    Kirlia: {
    ...
    Lairon: {
      types: ['Steel', 'Fire'],
      bs: {hp: 60, at: 90, df: 90, sa: 75, sd: 70, sp: 70},
      weightkg: 120,
      nfe: true,
      abilities: {0: 'Water Absorb'},
    },
    ...
    Linoone: {
      types: ['Normal'],
      bs: {hp: 85, at: 105, df: 75, sa: 50, sd: 65, sp: 130},
      weightkg: 32.5,
      abilities: {0: 'Speed Boost'},
    },
    Lombre: {
    ...
    Ludicolo: {
      types: ['Water', 'Grass'],
      bs: {hp: 90, at: 70, df: 80, sa: 115, sd: 100, sp: 80},
      weightkg: 55,
      abilities: {0: 'Swift Swim'},
    },
    Lunatone: {
      types: ['Rock', 'Ghost'],
      bs: {hp: 90, at: 60, df: 125, sa: 95, sd: 85, sp: 55},
      weightkg: 168,
      abilities: {0: 'Levitate'},
      gender: 'N',
    },
    Luvdisc: {
      types: ['Water','Fairy'],
      bs: {hp: 40, at: 30, df: 110, sa: 105, sd: 110, sp: 100},
      weightkg: 8.7,
      abilities: {0: 'Swift Swim'},
    },
    Makuhita: {
    ...
    Manectric: {
      types: ['Rock','Psychic'],
      bs: {hp: 70, at: 55, df: 70, sa: 130, sd: 80, sp: 112},
      weightkg: 40.2,
      abilities: {0: 'Static'},
    },
    Marshtomp: {
    ...
    Masquerain: {
      types: ['Bug', 'Water'],
      bs: {hp: 80, at: 50, df: 80, sa: 110, sd: 110, sp: 100},
      weightkg: 3.6,
      abilities: {0: 'Intimidate'},
    },
    Mawile: {
      types: ['Steel'],
      bs: {hp: 70, at: 70, df: 125, sa: 55, sd: 105, sp: 50},
      weightkg: 11.5,
      abilities: {0: 'Huge Power'},
    },
    Medicham: {
      types: ['Flying', 'Fighting'],
      bs: {hp: 65, at: 55, df: 65, sa: 125, sd: 70, sp: 90},
      weightkg: 31.5,
      abilities: {0: 'Pure Power'},
    },
    Meditite: {
      types: ['Flying', 'Fighting'],
      bs: {hp: 40, at: 25, df: 55, sa: 85, sd: 65, sp: 80},
      weightkg: 11.2,
      nfe: true,
      abilities: {0: 'Pure Power'},
    },
    ...
    Mightyena: {
      types: ['Psychic','Fairy'],
      bs: {hp: 90, at: 105, df: 80, sa: 100, sd: 75, sp: 105},
      weightkg: 37,
      abilities: {0: 'Adaptability'},
    },
    Milotic: {
      types: ['Water','Fairy'],
      bs: {hp: 95, at: 50, df: 89, sa: 100, sd: 125, sp: 81},
      weightkg: 162,
      abilities: {0: 'Marvel Scale'},
    },
    Minun: {
      types: ['Electric'],
      bs: {hp: 60, at: 60, df: 60, sa: 120, sd: 85, sp: 135},
      weightkg: 4.2,
      abilities: {0: 'Minus'},
    },
    Mudkip: {
    ...
    Ninjask: {
      types: ['Bug', 'Dark'],
      bs: {hp: 70, at: 115, df: 50, sa: 50, sd: 55, sp: 160},
      weightkg: 12,
      abilities: {0: 'Technician'},
    },
    Nosepass: {
      types: ['Rock'],
      bs: {hp: 30, at: 55, df: 135, sa: 55, sd: 90, sp: 30},
      weightkg: 97,
    ...
    Pelipper: {
      types: ['Water', 'Flying'],
      bs: {hp: 60, at: 50, df: 130, sa: 95, sd: 110, sp: 85},
      weightkg: 28,
      abilities: {0: 'Drizzle'},
    },
    Plusle: {
      types: ['Electric'],
      bs: {hp: 60, at: 60, df: 60, sa: 135, sd: 85, sp: 120},
      weightkg: 4.2,
      abilities: {0: 'Plus'},
    },
    Poochyena: {
      types: ['Psychic','Fairy'],
      bs: {hp: 50, at: 65, df: 50, sa: 55, sd: 40, sp: 90},
      weightkg: 13.6,
      nfe: true,
    ...
    Relicanth: {
      types: ['Water', 'Rock'],
      bs: {hp: 100, at: 100, df: 130, sa: 45, sd: 85, sp: 55},
      weightkg: 23.4,
      abilities: {0: 'Mold Breaker'},
    },
    Roselia: {
      types: ['Fairy', 'Fighting'],
      bs: {hp: 50, at: 50, df: 55, sa: 90, sd: 65, sp: 90},
      weightkg: 2,
      abilities: {0: 'Oblivious'},
    },
    Sableye: {
      types: ['Dark', 'Ghost'],
      bs: {hp: 50, at: 95, df: 95, sa: 95, sd: 95, sp: 95},
      weightkg: 11,
    ...
    Sceptile: {
      types: ['Grass','Dragon'],
      bs: {hp: 70, at: 105, df: 65, sa: 105, sd: 80, sp: 120},
      weightkg: 52.2,
      abilities: {0: 'Unburden'},
    },
    Sealeo: {
      types: ['Ice', 'Water'],
      bs: {hp: 90, at: 70, df: 70, sa: 75, sd: 70, sp: 45},
      weightkg: 87.6,
      nfe: true,
    ...
    Seviper: {
      types: ['Poison','Dark'],
      bs: {hp: 75, at: 115, df: 60, sa: 100, sd: 60, sp: 95},
      weightkg: 52.5,
      abilities: {0: 'Shed Skin'},
    },
    Sharpedo: {
      types: ['Water', 'Dark'],
      bs: {hp: 85, at: 120, df: 65, sa: 75, sd: 65, sp: 110},
      weightkg: 88.8,
      abilities: {0: 'Speed Boost'},
    },
    Shedinja: {
      types: ['Bug', 'Ghost'],
      bs: {hp: 1, at: 125, df: 5, sa: 125, sd: 5, sp: 85},
      weightkg: 1.2,
    ...
    Shiftry: {
      types: ['Grass', 'Dark'],
      bs: {hp: 90, at: 100, df: 60, sa: 100, sd: 60, sp: 110},
      weightkg: 59.6,
      abilities: {0: 'Chlorophyll'},
    },
    Shroomish: {
    ...
    Shuppet: {
      types: ['Ghost','Normal'],
      bs: {hp: 54, at: 75, df: 45, sa: 43, sd: 73, sp: 45},
      weightkg: 2.3,
      nfe: true,
    ...
    Skitty: {
      types: ['Normal','Fairy'],
      bs: {hp: 50, at: 65, df: 45, sa: 35, sd: 70, sp: 65},
      weightkg: 11,
      nfe: true,
      abilities: {0: 'Cute Charm'},
    },
    Slaking: {
      types: ['Normal'],
      bs: {hp: 100, at: 100, df: 100, sa: 80, sd: 100, sp: 50},
      weightkg: 130.5,
      abilities: {0: 'Unaware'},
    },
    Slakoth: {
    ...
    Solrock: {
      types: ['Fire', 'Ghost'],
      bs: {hp: 90, at: 60, df: 55, sa: 125, sd: 85, sp: 95},
      weightkg: 154,
      abilities: {0: 'Levitate'},
      gender: 'N',
    },
    Spheal: {
      types: ['Ice', 'Water'],
      bs: {hp: 70, at: 50, df: 50, sa: 55, sd: 50, sp: 25},
      weightkg: 39.5,
      nfe: true,
      abilities: {0: 'Ice Body'},
    },
    Spinda: {
      types: ['Normal'],
      bs: {hp: 75, at: 115, df: 75, sa: 115, sd: 75, sp: 100},
      weightkg: 5,
      abilities: {0: 'Simple Mind'},
    },
    Spoink: {
      types: ['Psychic'],
    ...
    Swablu: {
      types: ['Psychic', 'Flying'],
      bs: {hp: 50, at: 50, df: 60, sa: 50, sd: 80, sp: 60},
      weightkg: 1.2,
      nfe: true,
      abilities: {0: 'Flame Body'},
    },
    Swalot: {
      types: ['Poison'],
      bs: {hp: 200, at: 65, df: 70, sa: 85, sd: 75, sp: 25},
      weightkg: 80,
      abilities: {0: 'Liquid Ooze'},
    },
    Swampert: {
      types: ['Water', 'Ground'],
      bs: {hp: 110, at: 110, df: 100, sa: 85, sd: 90, sp: 50},
      weightkg: 81.9,
      abilities: {0: 'Water Absorb'},
    },
    Swellow: {
      types: ['Normal', 'Flying'],
      bs: {hp: 75, at: 115, df: 60, sa: 75, sd: 50, sp: 125},
      weightkg: 19.8,
      abilities: {0: 'Guts'},
    },
    Taillow: {
    ...
    Torkoal: {
      types: ['Fire'],
      bs: {hp: 80, at: 95, df: 140, sa: 95, sd: 80, sp: 20},
      weightkg: 80.4,
      abilities: {0: 'Drought'},
    },
    Trapinch: {
      types: ['Fire'],
      bs: {hp: 30, at: 65, df: 50, sa: 30, sd: 55, sp: 120},
      weightkg: 15,
      nfe: true,
      abilities: {0: 'Speed Boost'},
    },
    ...
    Tropius: {
      types: ['Grass', 'Fire'],
      bs: {hp: 125, at: 100, df: 70, sa: 95, sd: 80, sp: 85},
      weightkg: 100,
      abilities: {0: 'Chlorophyll'},
    },
    Vibrava: {
      types: ['Fire', 'Electric'],
      bs: {hp: 40, at: 85, df: 60, sa: 85, sd: 65, sp: 110},
      weightkg: 15.3,
      abilities: {0: 'Deadeye'},
      nfe: true,
    },
    ...
    Volbeat: {
      types: ['Bug','Electric'],
      bs: {hp: 65, at: 33, df: 75, sa: 127, sd: 95, sp: 110},
      weightkg: 17.7,
      abilities: {0: 'Tinted Lens'},
    },
    Wailmer: {
    ...
    Wailord: {
      types: ['Water','Flying'],
      bs: {hp: 170, at: 90, df: 75, sa: 90, sd: 75, sp: 40},
      weightkg: 398,
      abilities: {0: 'Unaware'},
    },
    Walrein: {
      types: ['Ice', 'Water'],
      bs: {hp: 110, at: 95, df: 90, sa: 105, sd: 90, sp: 65},
      weightkg: 150.6,
      abilities: {0: 'Ice Body'},
    },
    Whiscash: {
      types: ['Water', 'Ground'],
      bs: {hp: 140, at: 95, df: 83, sa: 91, sd: 81, sp: 40},
      weightkg: 23.6,
      abilities: {0: 'Strong Body'},
    },
    Whismur: {
    ...
    Zangoose: {
      types: ['Normal','Dark'],
      bs: {hp: 85, at: 135, df: 60, sa: 60, sd: 60, sp: 105},
      weightkg: 40.3,
      abilities: {0: 'Poison Heal'},
    },
    Zigzagoon: {
      types: ['Normal'],
      bs: {hp: 38, at: 40, df: 41, sa: 35, sd: 41, sp: 60},
      weightkg: 17.5,
      nfe: true,
...
var DPP_PATCH = {
    Aipom: {nfe: true},
    Altaria: {types: ['Psychic', 'Dragon']},
    Ampharos: {types: ['Grass', 'Normal']},
    Charizard: {types: ['Fire', 'Dragon']},
    Dusclops: {nfe: true},
    Electabuzz: {nfe: true},
    'Farfetch\u2019d': {types: ['Fighting', 'Flying']},
    Feraligatr: {types: ['Water', 'Dark']},
    Flygon: {types: ['Fire', 'Electric']},
    Glalie: {types: ['Ice', 'Rock']},
    Gligar: {nfe: true},
    ...
    Magmar: {nfe: true},
    Magneton: {nfe: true},
    Masquerain: {types: ['Bug', 'Water']},
    Meganium: {types: ['Grass', 'Fairy']},
    Milotic: {types: ['Water', 'Fairy']},
    Misdreavus: {types: ['Ghost', 'Fairy'], nfe: true},
    Murkrow: {nfe: true},
    Ninetales: {types: ['Fire', 'Fairy']},
    Noctowl: {types: ['Ghost', 'Flying']},
    Nosepass: {nfe: true},
    Piloswine: {nfe: true},
    ...
    Seviper: {types: ['Poison', 'Dark']},
    Sneasel: {nfe: true},
    Swablu: {types: ['Psychic', 'Flying']},
    Tangela: {nfe: true},
    Togetic: {types: ['Grass', 'Water'], nfe: true},
    Trapinch: {types: ['Fire']},
    Vibrava: {types: ['Fire', 'Electric']},
    ...
    Togepi: {types: ['Grass', 'Water']},
    Wigglytuff: {types: ['Normal', 'Fairy']},
  
    Abomasnow: {
      types: ['Grass', 'Ice'],
      bs: {hp: 110, at: 112, df: 95, sa: 102, sd: 105, sp: 30},
      weightkg: 135.5,
      abilities: {0: 'Snow Warning'},
    },
    Ambipom: {
      types: ['Normal','Fighting'],
      bs: {hp: 80, at: 125, df: 75, sa: 55, sd: 55, sp: 110},
      weightkg: 20.3,
      abilities: {0: 'Guts'},
    },
    Arceus: {
      types: ['Normal'],
      bs: {hp: 255, at: 120, df: 140, sa: 120, sd: 140, sp: 225},
      weightkg: 320,
    ...
    Bastiodon: {
      types: ['Dragon', 'Steel'],
      bs: {hp: 75, at: 90, df: 165, sa: 45, sd: 130, sp: 20},
      weightkg: 149.5,
      abilities: {0: 'Battle Armor'},
    },
    Bibarel: {
      types: ['Normal', 'Water'],
      bs: {hp: 105, at: 100, df: 90, sa: 55, sd: 90, sp: 71},
      weightkg: 31.5,
      abilities: {0: 'Simple'},
    },
    Bidoof: {
    ...
    Bronzong: {
      types: ['Steel', 'Psychic'],
      bs: {hp: 70, at: 95, df: 120, sa: 95, sd: 120, sp: 25},
      weightkg: 187,
      gender: 'N',
      abilities: {0: 'Levitate'},
    },
    ...
    Budew: {
      types: ['Fairy'],
      bs: {hp: 40, at: 20, df: 45, sa: 30, sd: 60, sp: 75},
      weightkg: 1.2,
      nfe: true,
      abilities: {0: 'Klutz'},
    },
    Buizel: {
      types: ['Water'],
      bs: {hp: 55, at: 75, df: 35, sa: 40, sd: 30, sp: 95},
      weightkg: 29.5,
      nfe: true,
      abilities: {0: 'Technician'},
    },
    Buneary: {
      types: ['Normal'],
      bs: {hp: 55, at: 76, df: 44, sa: 44, sd: 56, sp: 85},
      weightkg: 5.5,
      nfe: true,
      abilities: {0: 'Run Away'},
    },
    ...
    Carnivine: {
      types: ['Grass'],
      bs: {hp: 94, at: 140, df: 82, sa: 110, sd: 82, sp: 36},
      weightkg: 27,
      abilities: {0: 'Levitate'},
    },
    Chatot: {
      types: ['Normal', 'Flying'],
      bs: {hp: 75, at: 50, df: 55, sa: 120, sd: 65, sp: 130},
      weightkg: 1.9,
      abilities: {0: 'Trace'},
    },
    Cherrim: {
      types: ['Grass','Fairy'],
      bs: {hp: 80, at: 115, df: 75, sa: 80, sd: 85, sp: 105},
      weightkg: 9.3,
    ...
    Cherubi: {
      types: ['Grass'],
      bs: {hp: 45, at: 65, df: 45, sa: 40, sd: 50, sp: 55},
      weightkg: 3.3,
      abilities: {0: 'Chlorophyll'},
      nfe: true,
    },
    ...
    Chingling: {
      types: ['Fairy'],
      bs: {hp: 47, at: 27, df: 57, sa: 57, sd: 77, sp: 77},
      weightkg: 0.6,
      abilities: {0: 'Levitate'},
      nfe: true,
    },
    ...
    Drapion: {
      types: ['Poison', 'Dark'],
      bs: {hp: 70, at: 110, df: 110, sa: 60, sd: 85, sp: 95},
      weightkg: 61.5,
      abilities: {0: 'Sniper'},
    },
    Drifblim: {
      types: ['Ghost', 'Flying'],
      bs: {hp: 150, at: 55, df: 70, sa: 95, sd: 70, sp: 85},
      weightkg: 15,
      abilities: {0: 'Volt Absorb'},
    },
    Drifloon: {
      types: ['Ghost', 'Flying'],
      bs: {hp: 90, at: 30, df: 55, sa: 60, sd: 55, sp: 70},
      weightkg: 1.2,
      nfe: true,
      abilities: {0: 'Volt Absorb'},
    },
    Dusknoir: {
      types: ['Ghost'],
      bs: {hp: 65, at: 100, df: 135, sa: 65, sd: 135, sp: 45},
      weightkg: 106.6,
      abilities: {0: 'Iron Fist'},
    },
    Electivire: {
      types: ['Electric', 'Fighting'],
      bs: {hp: 85, at: 123, df: 65, sa: 105, sd: 80, sp: 97},
      weightkg: 138.6,
      abilities: {0: 'Motor Drive'},
    },
    Empoleon: {
      types: ['Water', 'Steel'],
      bs: {hp: 84, at: 92, df: 98, sa: 110, sd: 101, sp: 60},
      weightkg: 84.5,
      abilities: {0: 'Strong Body'},
    },
    Finneon: {
    ...
    Floatzel: {
      types: ['Water'],
      bs: {hp: 85, at: 120, df: 60, sa: 100, sd: 55, sp: 120},
      weightkg: 33.5,
      abilities: {0: 'Technician'},
    },
    Froslass: {
      types: ['Ice', 'Ghost'],
      bs: {hp: 70, at: 60, df: 70, sa: 120, sd: 90, sp: 120},
      weightkg: 26.6,
      abilities: {0: 'Levitate'},
    },
    Gabite: {
    ...
    Gallade: {
      ...
      bs: {hp: 68, at: 125, df: 65, sa: 50, sd: 115, sp: 107},
      weightkg: 52,
    ...
    Gastrodon: {
      types: ['Water', 'Ground'],
      bs: {hp: 111, at: 93, df: 78, sa: 102, sd: 102, sp: 39},
      weightkg: 29.9,
      abilities: {0: 'Rain Dish'},
    },
    Gible: {
    ...
    Glaceon: {
      types: ['Ice'],
      bs: {hp: 70, at: 60, df: 110, sa: 130, sd: 80, sp: 95},
      weightkg: 25.9,
      abilities: {0: 'Serene Grace'},
    },
    Glameow: {
    ...
    Grotle: {
      types: ['Grass'],
      bs: {hp: 75, at: 89, df: 85, sa: 40, sd: 65, sp: 51},
      weightkg: 97,
      nfe: true,
      abilities: {0: 'Shell Armor'},
    },
    ...
    Honchkrow: {
      types: ['Dark', 'Flying'],
      bs: {hp: 100, at: 125, df: 52, sa: 105, sd: 52, sp: 101},
      weightkg: 27.3,
      abilities: {0: 'Super Luck'},
    },
    Infernape: {
      types: ['Fire', 'Fighting'],
      bs: {hp: 76, at: 109, df: 71, sa: 109, sd: 71, sp: 109},
      weightkg: 55,
      abilities: {0: 'Iron Fist'},
    },
    Kricketot: {
      types: ['Bug'],
      bs: {hp: 37, at: 25, df: 41, sa: 75, sd: 41, sp: 25},
      weightkg: 2.2,
      nfe: true,
      abilities: {0: 'Run Away'},
    },
    Kricketune: {
      types: ['Bug','Normal'],
      bs: {hp: 70, at: 55, df: 70, sa: 130, sd: 70, sp: 105},
      weightkg: 25.5,
      abilities: {0: 'Scrappy'},
    },
    Leafeon: {
      types: ['Grass'],
      bs: {hp: 70, at: 130, df: 110, sa: 60, sd: 80, sp: 95},
      weightkg: 25.5,
      abilities: {0: 'Natural Cure'},
    },
    Lickilicky: {
      types: ['Normal'],
      bs: {hp: 120, at: 95, df: 95, sa: 90, sd: 95, sp: 50},
      weightkg: 140,
      abilities: {0: 'Unaware'},
    },
    Lopunny: {
      types: ['Normal', 'Fighting'],
      bs: {hp: 65, at: 126, df: 84, sa: 44, sd: 96, sp: 105},
      weightkg: 33.3,
      abilities: {0: 'Scrappy'},
    },
    Lucario: {
    ...
    Lumineon: {
      types: ['Water', 'Flying'],
      bs: {hp: 85, at: 60, df: 80, sa: 110, sd: 90, sp: 115},
      weightkg: 24,
      abilities: {0: 'Rain Dish'},
    },
    Luxio: {
    ...
    Luxray: {
      types: ['Electric', 'Dark'],
      bs: {hp: 100, at: 120, df: 79, sa: 95, sd: 79, sp: 80},
      weightkg: 42,
      abilities: {0: 'Intimidate'},
    },
    Magmortar: {
      types: ['Fire'],
      bs: {hp: 85, at: 95, df: 64, sa: 125, sd: 90, sp: 96},
      weightkg: 68,
      abilities: {0: 'Deadeye'},
    },
    Magnezone: {
    ...
    Mismagius: {
      types: ['Ghost', 'Fairy'],
      bs: {hp: 60, at: 60, df: 60, sa: 115, sd: 115, sp: 115},
      weightkg: 4.4,
      abilities: {0: 'Levitate'},
    },
    Monferno: {
    ...
    Mothim: {
      types: ['Bug', 'Flying'],
      bs: {hp: 70, at: 110, df: 50, sa: 115, sd: 50, sp: 105},
      weightkg: 23.3,
      abilities: {0: 'Tinted Lens'},
    },
    Munchlax: {
    ...
    Pachirisu: {
      ...
      bs: {hp: 70, at: 40, df: 70, sa: 125, sd: 90, sp: 115},
      weightkg: 3.9,
      abilities: {0: 'Volt Absorb'},
    },
    Palkia: {
    ...
    'Porygon-Z': {
      types: ['Electric'],
      bs: {hp: 85, at: 70, df: 70, sa: 130, sd: 70, sp: 110},
      weightkg: 34,
      gender: 'N',
      abilities: {0: 'Levitate'},
    },
    ...
    Probopass: {
      types: ['Rock', 'Electric'],
      bs: {hp: 70, at: 45, df: 145, sa: 90, sd: 150, sp: 35},
      weightkg: 340,
      abilities: {0: 'Magnet Pull'},
    },
    Purugly: {
      types: ['Normal','Dark'],
      bs: {hp: 115, at: 105, df: 90, sa: 55, sd: 70, sp: 95},
      weightkg: 43.8,
      abilities: {0: 'Thick Fat'},
    },
    Rampardos: {
      types: ['Dragon','Rock'],
      bs: {hp: 135, at: 145, df: 65, sa: 55, sd: 55, sp: 70},
      weightkg: 102.5,
      abilities: {0: 'Mold Breaker'},
    },
    Regigigas: {
    ...
    Rhyperior: {
      types: ['Ground', 'Rock'],
      bs: {hp: 115, at: 140, df: 130, sa: 55, sd: 75, sp: 20},
      weightkg: 282.8,
      abilities: {0: 'Solid Rock'},
    },
    Riolu: {
    ...
    Roserade: {
      types: ['Fairy', 'Fighting'],
      bs: {hp: 60, at: 60, df: 75, sa: 130, sd: 85, sp: 105},
      weightkg: 14.5,
      abilities: {0: 'Pure Power'},
    },
    Rotom: {
    ...
    Skuntank: {
      types: ['Poison', 'Dark'],
      bs: {hp: 125, at: 95, df: 90, sa: 50, sd: 85, sp: 85},
      weightkg: 38,
    ...
    Spiritomb: {
      types: ['Ghost', 'Dark'],
      bs: {hp: 75, at: 92, df: 108, sa: 92, sd: 108, sp: 25},
      weightkg: 108,
      abilities: {0: 'Pressure'},
    },
    Staraptor: {
      types: ['Normal', 'Flying'],
      bs: {hp: 95, at: 120, df: 70, sa: 50, sd: 60, sp: 105},
      weightkg: 24.9,
    ...
    Tangrowth: {
      types: ['Grass'],
      bs: {hp: 100, at: 100, df: 125, sa: 110, sd: 60, sp: 50},
      weightkg: 128.6,
      abilities: {0: 'Thick Fat'},
    },
    Togekiss: {
      types: ['Grass', 'Water'],
      bs: {hp: 85, at: 120, df: 125, sa: 50, sd: 85, sp: 80},
      weightkg: 38,
      abilities: {0: 'No Guard'},
    },
    Torterra: {
      types: ['Grass', 'Rock'],
      bs: {hp: 100, at: 110, df: 120, sa: 55, sd: 90, sp: 70},
      weightkg: 310,
      abilities: {0: 'Solid Rock'},
    },
    Toxicroak: {
      types: ['Poison', 'Fighting'],
      bs: {hp: 83, at: 108, df: 65, sa: 108, sd: 65, sp: 111},
      weightkg: 44.4,
      abilities: {0: 'Dry Skin'},
    },
    Turtwig: {
      types: ['Grass'],
      bs: {hp: 55, at: 68, df: 64, sa: 30, sd: 55, sp: 46},
      weightkg: 10.2,
      nfe: true,
      abilities: {0: 'Shell Armor'},
    },
    ...
    Vespiquen: {
      types: ['Bug', 'Flying'],
      bs: {hp: 105, at: 90, df: 130, sa: 90, sd: 130, sp: 10},
      weightkg: 38.5,
      abilities: {0: 'Filter'},
    },
    Weavile: {
    ...
    Yanmega: {
      types: ['Bug', 'Dragon'],
      bs: {hp: 86, at: 66, df: 86, sa: 126, sd: 76, sp: 95},
      weightkg: 51.5,
      abilities: {0: 'Speed Boost'},
    },
  };
...
var XY_PATCH = {
    ...
    Togekiss: {types: ['Grass', 'Water']},
    Togepi: {types: ['Grass','Water']},
    Togetic: {types: ['Grass', 'Water']},
    Tyranitar: {otherFormes: ['Tyranitar-Mega']},
    Unfezant: {bs: {at: 115}},
    Venusaur: {otherFormes: ['Venusaur-Mega']},
    Victreebel: {bs: {sd: 100}},
    Vileplume: {bs: {sa: 110}},
...
var SM_PATCH = {
    ...
    Ariados: {bs: {sd: 90}},
    Beartic: {bs: {at: 130}},
    Chimecho: {bs: {hp: 78, df: 88, sd: 128}},
    Corsola: {bs: {hp: 75, df: 150, sd: 150}},
    ...
    Illumise: {bs: {df: 75, sd: 95}},
    Lunatone: {bs: {hp: 90}},
    Magcargo: {bs: {hp: 80, sa: 100}},
    Mantine: {bs: {hp: 95}},
    Marowak: {otherFormes: ['Marowak-Alola', 'Marowak-Alola-Totem']},
    Masquerain: {bs: {sa: 110, sp: 100}},
